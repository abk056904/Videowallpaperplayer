...
#define FFMPEG_CONFIGURATION "--enable-gpl --enable-shared --disable-static --disable-programs --disable-doc --disable-manpages --disable-autodetect --enable-small --disable-network --enable-d3d11va --disable-encoders --disable-muxers --disable-filters --disable-bsfs --disable-parsers --disable-decoders --disable-demuxers --disable-devices --disable-avdevice --disable-protocols --enable-protocol=file --enable-decoder='h264,hevc,vp9,av1' --enable-decoder='aac,aac_fixed,aac_latm,mp3,mp3float,opus,flac,ac3,ac3_fixed,eac3' --enable-decoder='pcm_s16le,pcm_s16be,pcm_s24le,pcm_s32le,pcm_f32le' --enable-demuxer='matroska,mov,avi,mpegts,flv,ogg,wav,mp3' --enable-parser='h264,hevc,vp9,av1,aac,mp3,flac,opus,ac3' --enable-bsf='h264_mp4toannexb,hevc_mp4toannexb,av1_metadata,vp9_metadata' --enable-swresample --enable-swscale"
#define FFMPEG_LICENSE "GPL version 2 or later"
#define CONFIG_THIS_YEAR 2026
#define FFMPEG_DATADIR "/usr/local/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/share/ffmpeg"
#define CC_IDENT "gcc 16.2.0 (Rev3, Built by MSYS2 project)"
